...
public class UpdatingsAdapter extends ArrayAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null) {
			...
			viewHolder.tv_updatingsItemTitle = (TextView)convertView.findViewById(R.id.tv_updatingsItemTitle);
			viewHolder.tv_updatingsItemContext = (TextView)convertView.findViewById(R.id.tv_updatingsItemContext);
			viewHolder.tv_updatingsItemRate = (TextView)convertView.findViewById(R.id.tv_updatingsItemRate);
			viewHolder.tv_updatingsItemTime = (TextView)convertView.findViewById(R.id.tv_updatingsItemTime);
